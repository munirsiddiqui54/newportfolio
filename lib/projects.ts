export interface Project {
  ...
  const projectArray: Project[] = [
    ...
    //Serverless Todo app
    {
      ...
      keyPoints: ["Task CRUD Operations", "Serverless Architecture", "Realtime Sync"],
    ...
    //Alegria Mobile App    
    {
      ...
      description:"I developed and deployed the official Alegria College Fest app using Flutter, available on the Play Store for Android and as a PWA for iOS and web. The app featured pass booking, social posts, event participation tracking, and an admin panel for real-time updates—showcasing my full-stack mobile development and cross-platform deployment skills.",
      ...
      keyPoints: ["Cross-Platform Development", "Mood Tracking", "Mindfulness Exercises"],
      ...
      playstore:"https://play.google.com/store/apps/details?id=com.threads.alegria&hl=en_IN"
    },
    ...
    //Marks Prediction
    {
      ...
      keyPoints: [ "Data Ingestion: Loading and preprocessing raw data.","Data Transformation: Feature engineering and data transformation.","Model Training: Training machine learning models to predict student scores.", "Logging: Custom logging to track the pipeline execution.","Exception Handling: Custom exceptions to handle errors gracefully."],
