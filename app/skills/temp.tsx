...
export default function Skills() {
  ...
  return (
    <div className="container mx-auto pt-16 md:pt-24 px-4">
...
function SkillCard({ skill }: { skill: Skill }) {
  return (
    <div className="bg-[#262626] rounded-lg p-6 flex items-center gap-4 transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-lg hover:shadow-purple-900/20">
